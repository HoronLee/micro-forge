...
func (x *ClickHouse) Reset() {
	*x = ClickHouse{}
	mi := &file_servora_contrib_db_clickhouse_v1_config_proto_msgTypes[0]
...
func (*ClickHouse) Descriptor() ([]byte, []int) {
	return file_servora_contrib_db_clickhouse_v1_config_proto_rawDescGZIP(), []int{0}
}
...
var File_servora_contrib_db_clickhouse_v1_config_proto protoreflect.FileDescriptor

const file_servora_contrib_db_clickhouse_v1_config_proto_rawDesc = "" +
	"\n" +
	"-servora/contrib/db/clickhouse/v1/config.proto\x12 servora.contrib.db.clickhouse.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!servora/conf/v1/annotations.proto\x1a$servora/security/tls/v1/config.proto\"\xb2\x04\n" +
	"\n" +
	"ClickHouse\x12\x1c\n" +
...
var (
	...
	file_servora_contrib_db_clickhouse_v1_config_proto_rawDescData []byte
)

func file_servora_contrib_db_clickhouse_v1_config_proto_rawDescGZIP() []byte {
	file_servora_contrib_db_clickhouse_v1_config_proto_rawDescOnce.Do(func() {
		file_servora_contrib_db_clickhouse_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_servora_contrib_db_clickhouse_v1_config_proto_rawDesc), len(file_servora_contrib_db_clickhouse_v1_config_proto_rawDesc)))
	})
	return file_servora_contrib_db_clickhouse_v1_config_proto_rawDescData
}

var file_servora_contrib_db_clickhouse_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_servora_contrib_db_clickhouse_v1_config_proto_goTypes = []any{
	(*ClickHouse)(nil),          // 0: servora.contrib.db.clickhouse.v1.ClickHouse
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(*v1.TLS)(nil),              // 2: servora.security.tls.v1.TLS
}
var file_servora_contrib_db_clickhouse_v1_config_proto_depIdxs = []int32{
	1, // 0: servora.contrib.db.clickhouse.v1.ClickHouse.dial_timeout:type_name -> google.protobuf.Duration
	1, // 1: servora.contrib.db.clickhouse.v1.ClickHouse.read_timeout:type_name -> google.protobuf.Duration
	1, // 2: servora.contrib.db.clickhouse.v1.ClickHouse.conn_max_lifetime:type_name -> google.protobuf.Duration
	2, // 3: servora.contrib.db.clickhouse.v1.ClickHouse.tls:type_name -> servora.security.tls.v1.TLS
...
func init() { file_servora_contrib_db_clickhouse_v1_config_proto_init() }
func file_servora_contrib_db_clickhouse_v1_config_proto_init() {
	if File_servora_contrib_db_clickhouse_v1_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_servora_contrib_db_clickhouse_v1_config_proto_rawDesc), len(file_servora_contrib_db_clickhouse_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_servora_contrib_db_clickhouse_v1_config_proto_goTypes,
		DependencyIndexes: file_servora_contrib_db_clickhouse_v1_config_proto_depIdxs,
		MessageInfos:      file_servora_contrib_db_clickhouse_v1_config_proto_msgTypes,
	}.Build()
	File_servora_contrib_db_clickhouse_v1_config_proto = out.File
	file_servora_contrib_db_clickhouse_v1_config_proto_goTypes = nil
	file_servora_contrib_db_clickhouse_v1_config_proto_depIdxs = nil
}
