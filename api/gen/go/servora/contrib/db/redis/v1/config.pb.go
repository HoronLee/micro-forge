...
func (x *Redis) Reset() {
	*x = Redis{}
	mi := &file_servora_contrib_db_redis_v1_config_proto_msgTypes[0]
...
func (*Redis) Descriptor() ([]byte, []int) {
	return file_servora_contrib_db_redis_v1_config_proto_rawDescGZIP(), []int{0}
}
...
var (
	...
	file_servora_contrib_db_redis_v1_config_proto_rawDescData []byte
)

func file_servora_contrib_db_redis_v1_config_proto_rawDescGZIP() []byte {
	file_servora_contrib_db_redis_v1_config_proto_rawDescOnce.Do(func() {
		file_servora_contrib_db_redis_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_servora_contrib_db_redis_v1_config_proto_rawDesc), len(file_servora_contrib_db_redis_v1_config_proto_rawDesc)))
	})
	return file_servora_contrib_db_redis_v1_config_proto_rawDescData
}

var file_servora_contrib_db_redis_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_servora_contrib_db_redis_v1_config_proto_init() {
	if File_servora_contrib_db_redis_v1_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_servora_contrib_db_redis_v1_config_proto_rawDesc), len(file_servora_contrib_db_redis_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_servora_contrib_db_redis_v1_config_proto_goTypes,
		DependencyIndexes: file_servora_contrib_db_redis_v1_config_proto_depIdxs,
		MessageInfos:      file_servora_contrib_db_redis_v1_config_proto_msgTypes,
	}.Build()
	File_servora_contrib_db_redis_v1_config_proto = out.File
	file_servora_contrib_db_redis_v1_config_proto_goTypes = nil
	file_servora_contrib_db_redis_v1_config_proto_depIdxs = nil
}
