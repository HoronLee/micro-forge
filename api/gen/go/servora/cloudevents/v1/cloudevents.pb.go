...
//
// Servora-hosted copy of the CNCF CloudEvents protobuf format specification.
// Source: https://github.com/cloudevents/spec/blob/main/cloudevents/formats/cloudevents.proto
//
// Only `package` and `go_package` are modified; all messages, fields, and field
// numbers are identical to the upstream spec.
...
func (x *CloudEvent) Reset() {
	*x = CloudEvent{}
	mi := &file_servora_cloudevents_v1_cloudevents_proto_msgTypes[0]
...
func (*CloudEvent) Descriptor() ([]byte, []int) {
	return file_servora_cloudevents_v1_cloudevents_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudEventBatch) Reset() {
	*x = CloudEventBatch{}
	mi := &file_servora_cloudevents_v1_cloudevents_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudEventBatch) Descriptor() ([]byte, []int) {
	return file_servora_cloudevents_v1_cloudevents_proto_rawDescGZIP(), []int{1}
}
...
var File_servora_cloudevents_v1_cloudevents_proto protoreflect.FileDescriptor

const file_servora_cloudevents_v1_cloudevents_proto_rawDesc = "" +
	"\n" +
	"(servora/cloudevents/v1/cloudevents.proto\x12\x16servora.cloudevents.v1\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd9\x05\n" +
	"\n" +
	"CloudEvent\x12\x0e\n" +
	...
	"\n" +
	"attributes\x18\x05 \x03(\v22.servora.cloudevents.v1.CloudEvent.AttributesEntryR\n" +
	"attributes\x12!\n" +
...
var (
	...
	file_servora_cloudevents_v1_cloudevents_proto_rawDescData []byte
)

func file_servora_cloudevents_v1_cloudevents_proto_rawDescGZIP() []byte {
	file_servora_cloudevents_v1_cloudevents_proto_rawDescOnce.Do(func() {
		file_servora_cloudevents_v1_cloudevents_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_servora_cloudevents_v1_cloudevents_proto_rawDesc), len(file_servora_cloudevents_v1_cloudevents_proto_rawDesc)))
	})
	return file_servora_cloudevents_v1_cloudevents_proto_rawDescData
}
...
func init() { file_servora_cloudevents_v1_cloudevents_proto_init() }
func file_servora_cloudevents_v1_cloudevents_proto_init() {
	if File_servora_cloudevents_v1_cloudevents_proto != nil {
		return
	}
	file_servora_cloudevents_v1_cloudevents_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_servora_cloudevents_v1_cloudevents_proto_rawDesc), len(file_servora_cloudevents_v1_cloudevents_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_servora_cloudevents_v1_cloudevents_proto_goTypes,
		DependencyIndexes: file_servora_cloudevents_v1_cloudevents_proto_depIdxs,
		MessageInfos:      file_servora_cloudevents_v1_cloudevents_proto_msgTypes,
	}.Build()
	File_servora_cloudevents_v1_cloudevents_proto = out.File
	file_servora_cloudevents_v1_cloudevents_proto_goTypes = nil
	file_servora_cloudevents_v1_cloudevents_proto_depIdxs = nil
}
